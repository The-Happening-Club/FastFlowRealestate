...
const EyeClosedIcon: React.FC<IIcons> = ({ size, strokeColor, fillColor }) => {
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
      ...
      <path
        d="M3 16C11 21.3333 19 21.3333 27 16"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M23.855 22.6524L22.54 19.0574"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M17.865 24.0574L17.45 20.2524"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M11.72 23.9875L12.22 20.1975"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M5.76501 22.4573L7.15501 18.8923"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
...
const EyeOpenIcon: React.FC<IIcons> = ({ size, strokeColor, fillColor }) => {
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
      <rect width="30" height="30" fill="none" />
      <path
        d="M3.46237 15.8412C11.1858 10.1874 18.9093 10.1874 26.6328 15.8412C18.9093 21.4999 11.1858 21.4999 3.46237 15.8412Z"
        stroke={strokeColor}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M15.0476 20.1486C17.3182 20.1486 19.1588 18.3164 19.1588 16.0563C19.1588 13.7961 17.3182 11.9639 15.0476 11.9639C12.7771 11.9639 10.9364 13.7961 10.9364 16.0563C10.9364 18.3164 12.7771 20.1486 15.0476 20.1486Z"
        stroke={strokeColor}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M15.0476 18.2671C16.2743 18.2671 17.2686 17.2772 17.2686 16.0562C17.2686 14.8351 16.2743 13.8452 15.0476 13.8452C13.8209 13.8452 12.8265 14.8351 12.8265 16.0562C12.8265 17.2772 13.8209 18.2671 15.0476 18.2671Z"
        fill={fillColor}
      />
      <path
        d="M2.09518 13.6637C10.7301 7.38424 19.3651 7.38424 28 13.6637"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M22.5648 18.668L23.1357 20.2247"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M17.4414 19.8618L17.6237 21.5093"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M12.1837 19.8044L11.9678 21.4471"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
      <path
        d="M7.09389 18.501L6.48944 20.0434"
        stroke={strokeColor}
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
  ...
  return (
    <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M23.4783 4H6.52174L0 18.0217H1.95655L7.62757 5.63057H22.3724L28.0434 18.0217H30L23.4783 4Z"
        fill={fillColor}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.78264 18.0217H0V25.1956H30V18.0217H19.5652L18.2609 20.6304H11.087L9.78264 18.0217Z"
        fill={fillColor}
      />
    </svg>
  );
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 30 30" fill="none">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16.3575 7.14809C16.5117 6.09276 15.1276 5.56132 14.5359 6.44874L10.1874 12.9715C10.0515 13.1754 10.0021 13.3983 10.021 13.6101C10.0074 13.6528 10 13.7001 10 13.7526V20.7535C10 21.8581 10.8954 22.7526 12 22.7526H20.4035C21.3373 22.7526 22.1469 22.1065 22.3538 21.1959L23.9447 14.1959C24.2292 12.9444 23.2779 11.7526 21.9945 11.7526H15.6844L16.3575 7.14809Z"
        fill={fillColor}
      />
    </svg>
  );
...
const ChevronUpIcon: React.FC<IIcons> = ({
  size,
  strokeColor,
  strokeWidth = "4",
}) => {
...
const ChevronRightIcon: React.FC<IIcons> = ({
  size,
  strokeColor,
  strokeWidth = "4",
}) => {
...
const ChevronLeftIcon: React.FC<IIcons> = ({
  size,
  strokeColor,
  strokeWidth = "4",
}) => {
...
const PenIcon: React.FC<IIcons> = ({ size, fillColor }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 10 14" fill="none">
      <path
        d="M7.38397 0.871001C7.52204 0.631855 7.82784 0.549917 8.06698 0.687988L8.93301 1.18799C9.17216 1.32606 9.25409 1.63185 9.11602 1.871L8.86602 2.30401L7.13397 1.30401L7.38397 0.871001Z"
        fill={fillColor}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.36602 3.16992L6.63397 2.16992L1.63397 10.8302C1.63397 10.8302 1.06698 12.8122 1.5 13.0622C1.93301 13.3122 3.36602 11.8302 3.36602 11.8302L8.36602 3.16992Z"
        fill={fillColor}
      />
    </svg>
  );
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 30 40" fill="none">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22.6957 18H6.30435L0 31.5543H1.89135L7.37331 19.5763H21.6266L27.1086 31.5543H29L22.6957 18Z"
        fill={fillColor}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.45662 31.5544H0V38.4892H29V31.5544H18.913L17.6522 34.0761H10.7174L9.45662 31.5544Z"
        fill={fillColor}
      />
      <rect x="12" y="8" width="5" height="10" rx="0.5" fill={fillColor} />
      <path
        d="M14.933 24.25C14.7406 24.5833 14.2594 24.5833 14.067 24.25L10.1699 17.5C9.97742 17.1667 10.218 16.75 10.6029 16.75H18.3971C18.782 16.75 19.0226 17.1667 18.8301 17.5L14.933 24.25Z"
        fill={fillColor}
      />
    </svg>
  );
...
const SearchIcon: React.FC<IIcons> = ({ size, strokeWidth, strokeColor }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 30 31" fill="none">
      <path
        d="M18.6746 8.17958C20.5722 11.2881 19.4725 15.329 16.0953 17.1731C12.7181 19.0173 8.46822 17.8975 6.5707 14.7891C4.67318 11.6806 5.77282 7.63965 9.15002 5.7955C12.5272 3.95135 16.7771 5.0711 18.6746 8.17958Z"
        stroke={strokeColor}
        stroke-width={strokeWidth}
      />
      <path
        d="M16.8768 18.4534L21.7692 26.4679"
        stroke={strokeColor}
        stroke-width={strokeWidth}
        stroke-linecap="round"
      />
