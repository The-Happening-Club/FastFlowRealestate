...
import { FilterIcon, StapleIcon } from "@/components/icons/icons";
import OrderControlls from "./OrderControlls";
...
const OrderTable = () => {
  ...
  return (
      <div className="relative flex flex-col bg-slate-50 w-full max-h-screen rounded-md overflow-hidden mx-8 mt-8 mb-16">

          <OrderModal open={modalOpen} setOpenModal={setModalOpen}/>
          <OrderControlls open={modalOpen} setOpenModal={setModalOpen}/>
